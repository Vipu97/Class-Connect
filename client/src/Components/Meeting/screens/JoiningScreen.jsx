...
import { createMeeting, getToken, validateMeeting } from "../../../utils/api";
  ...
  return (
    <div className="fixed inset-0">
      <div className="overflow-y-auto flex flex-col flex-1 h-screen bg-gray-800">
        <div className="flex flex-1 flex-col md:flex-row items-center justify-center my-8 xl:mx-16">
          <div className="w-full flex flex-col gap-y-9 xl:gap-x-16 lg:flex-row lg:justify-around xl:justify-center">
            <div className="md:col-span-7 2xl:col-span-7 col-span-12">
              <div className="flex items-center justify-center p-1.5 sm:p-4 xl:p-12">
                <div className="relative w-full px-5">
                  <div className="w-full relative max-w-[600px] mx-auto h-[40vh] xs:h-[50vh]">
                    <video
                      autoPlay
                      playsInline
                      muted
                    ...
                    <div className="absolute bottom-3 md:bottom-6 right-0 left-4 xs:left-8 sm:left-7">
                  ...
                  <>
                    <div className="flex flex-row mt-3 justify-center gap-x-8 gap-y-5 flex-wrap">
                      <DropDown
                        mics={mics}
                        changeMic={changeMic}
            ...
            <div className="flex items-center justify-center">
              <div
                className="flex flex-col w-[300px] xs:w-[400px] lg:w-[350px]
